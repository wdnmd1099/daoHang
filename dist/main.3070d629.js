...
var zObject = JSON.parse(z);
var hashMap = zObject || [{ "logo": "C", "url": "https://www.cnblogs.com/deerchao/archive/2006/08/24/zhengzhe30fengzhongjiaocheng.html" }, { "logo": "J", "url": "https://www.jquery123.com/" }];
...
$('.addButton').on('click', function () {
    var url1 = window.prompt('请输入想收藏的网址：');
    url = url1;
...
window.onbeforeunload = function () {
    //检测在离开网页时，把字符串存到localStorage的'x'里
    var string = JSON.stringify(hashMap); //JSON.stringify(hashMap) 把hashMap(对象)转成字符串
...
//# sourceMappingURL=/main.3070d629.map